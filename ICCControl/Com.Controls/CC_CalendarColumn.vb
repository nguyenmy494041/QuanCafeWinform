Public Class CC_CalendarColumn
    ...
    Public Overrides Function Clone() As Object
        Dim TheCopy As CC_CalendarColumn = DirectCast(MyBase.Clone(), CC_CalendarColumn)
...
Public Class CalendarCell
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer, ByVal initialFormattedValue As Object, ByVal dataGridViewCellStyle As DataGridViewCellStyle)
        ...
        Dim MyOwner As CC_CalendarColumn = CType(OwningColumn, CC_CalendarColumn)
        Me.Style.Format = MyOwner.DateFormat
        TheControl.Format = DateTimePickerFormat.Custom
        'TheControl.Format = MyOwner.DateFormat
