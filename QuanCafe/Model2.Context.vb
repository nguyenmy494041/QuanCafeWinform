...
Partial Public Class NCVEntities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=NCVEntities")
    End Sub
    ...
    Public Overridable Property School() As DbSet(Of School)
    Public Overridable Property sysdiagrams() As DbSet(Of sysdiagrams)

    Public Overridable Function getCourse() As ObjectResult(Of getCourse_Result)
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of getCourse_Result)("getCourse")
    End Function

    Public Overridable Function getdatatablescholl() As ObjectResult(Of getdatatablescholl_Result)
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of getdatatablescholl_Result)("getdatatablescholl")
    End Function

    Public Overridable Function getinformationByIdstudent(idstudent As Nullable(Of Integer)) As ObjectResult(Of getinformationByIdstudent_Result)
        Dim idstudentParameter As ObjectParameter = If(idstudent.HasValue, New ObjectParameter("idstudent", idstudent), New ObjectParameter("idstudent", GetType(Integer)))

        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of getinformationByIdstudent_Result)("getinformationByIdstudent", idstudentParameter)
    End Function

    Public Overridable Function getinformationstudent(rownuum As Nullable(Of Integer)) As ObjectResult(Of getinformationstudent_Result)
        Dim rownuumParameter As ObjectParameter = If(rownuum.HasValue, New ObjectParameter("rownuum", rownuum), New ObjectParameter("rownuum", GetType(Integer)))

        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of getinformationstudent_Result)("getinformationstudent", rownuumParameter)
    End Function

    Public Overridable Function getRegion() As ObjectResult(Of getRegion_Result)
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of getRegion_Result)("getRegion")
    End Function

    Public Overridable Function searchSchool(schoolcode As Nullable(Of Integer)) As ObjectResult(Of searchSchool_Result)
        Dim schoolcodeParameter As ObjectParameter = If(schoolcode.HasValue, New ObjectParameter("schoolcode", schoolcode), New ObjectParameter("schoolcode", GetType(Integer)))

        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of searchSchool_Result)("searchSchool", schoolcodeParameter)
    End Function
